...
export default {
    ...
    methods: {
        change(e){
            this.$store.commit('ApiList/setAPiName',{name: "apiQesponseSuccess", value: e })
        }
    },
    computed: {
        apiItem(){
...
.ResponseSuccessCode >>> .CodeMirror-gutters{
